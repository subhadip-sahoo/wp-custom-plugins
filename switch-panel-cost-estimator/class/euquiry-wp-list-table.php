		...
		foreach ( $columns as $column_name => $column_display_name ) {
			...
			elseif ( method_exists( $this, 'column_' . $column_name ) ) {
				...
				echo "</td>";
                        ...
                        elseif ( 'estimated_cost' == $column_name ) {
                            
				echo "<td $attributes>";
                                echo $this->column_default( $item, $column_name ).' '.get_option('switch_panel_price_unit');
				echo "</td>";
			}
                        elseif ( 'enquiry_date' == $column_name ) {
                            
				echo "<td $attributes>";
                                echo date($date_format, strtotime($this->column_default( $item, $column_name ))).' at '. date($time_format, strtotime($this->column_default( $item, $column_name )));
				echo "</td>";
			}
			else {
				echo "<td $attributes>";
