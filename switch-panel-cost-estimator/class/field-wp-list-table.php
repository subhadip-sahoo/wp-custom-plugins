		...
		foreach ( $columns as $column_name => $column_display_name ) {
			...
			elseif ( method_exists( $this, 'column_' . $column_name ) ) {
				...
				echo "</td>";
                        ...
                        elseif ( 'popup_image' == $column_name ) {
                            
				echo "<td $attributes>";
                                echo ($this->column_default( $item, $column_name ) != '')?"<img src='".$this->column_default( $item, $column_name )."' height='50' width='50'>":"<img src='".plugins_url()."/switch-panel-cost-estimator/images/noMediaUploaded.png' height='50' width='50'>";
				echo "</td>";
			}
                        elseif ( 'popup_description' == $column_name ) {
                            
				echo "<td $attributes>";
                                echo stripslashes_deep($this->column_default( $item, $column_name ));
				echo "</td>";
			}
			else {
				echo "<td $attributes>";
